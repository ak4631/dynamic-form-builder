...
import { Card, FormControl, FormControlLabel, FormLabel, Grid, Radio, RadioGroup, Switch,Tooltip } from "@mui/material";
...
function OptiLayout() {
  ...
  const handleConfig = () => navigate(`/layoutbuilder`, { state: { layoutId: layoutId } });
  ...
  const getLayoutData = async (id) => {
    try {
      ...
      const selectedModuleOption = moduleList.find(
        moduleList => moduleList.value === data.details.mlModuleId
      );
          ...
          <Card sx={{ borderRadius: '10px', padding: '15px' }}>
            <SoftBox display="flex" justifyContent="space-between" alignItems="center" pt={3} px={2}>
              ...
              <SoftBox display="flex">
                <Tooltip title="Add New Layout" placement="top">
