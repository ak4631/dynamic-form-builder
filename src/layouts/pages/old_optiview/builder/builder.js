    ...
    return (
        <Paper sx={{ p: 1 }}>
            <div className="layout-container">
                ...
                >
                    <SoftTypography
                        component="label" variant="caption" fontWeight="bold" fontSize="1rem" sx={{ my: 1, color: "#4d6b5c" }}
                    >Items</SoftTypography>
                ...
                >
                    ...
                    <SoftTypography
                        component="label" variant="caption" fontWeight="bold" fontSize="1rem" sx={{ my: 1, color: "#4d6b5c" }}
                    >Property Editor</SoftTypography>
                    {selectedElement && (
                        <SoftBox sx={{ width: "100%" }}>
                            {/* <p>Selected Element: {selectedElement.id}</p> */}
