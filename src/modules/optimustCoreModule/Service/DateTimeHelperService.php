...
use Optimust\Core\Helper\LocalizedDateFormatter;
...
class DateTimeHelperService
{
     ...
     * @return string|null
     */
    public function formatProvidedDate(?DateTime $dateTime, $format = 'Y-m-d'): ?string
    {
        if (is_null($dateTime)) {
            return null;
        }

        return $this->getDateFormatter()->formatDate($dateTime, $format);
    }
