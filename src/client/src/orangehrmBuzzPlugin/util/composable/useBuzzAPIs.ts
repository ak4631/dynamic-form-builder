...
export default function useBuzzAPIs(http: APIService) {
  const fetchPostComments = (
    ...
    return http.request({
      method: 'GET',
      url: `/api/v1/buzz/shares/${postId}/comments`,
      params: {
        limit: limit,
  ...
  const updatePostComment = (
    ...
    return http.request({
      method: 'PUT',
      url: `/api/v1/buzz/shares/${postId}/comments/${commentId}`,
      data: {text: comment},
    });
  };
  ...
  const fetchPostLikes = (postId: number): Promise<AxiosResponse> => {
    return http.request({
      method: 'GET',
      url: `/api/v1/buzz/shares/${postId}/likes`,
    });
  };
  ...
  const updateCommentLike = (
    ...
    return http.request({
      method: like ? 'DELETE' : 'POST',
      url: `/api/v1/buzz/comments/${commentId}/likes`,
    });
  };
