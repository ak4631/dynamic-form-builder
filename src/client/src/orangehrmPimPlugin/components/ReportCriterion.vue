    ...
    switch (props.criterion.key) {
      ...
      case 'employment_status':
        field.value = {
          name: props.criterion.label,
          component: 'report-criterion-select',
          api: '/api/v1/admin/employment-statuses',
          options: [],
        };
        break;
