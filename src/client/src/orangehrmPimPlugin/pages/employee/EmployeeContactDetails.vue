...
export default {
  ...
  setup(props) {
    const http = new APIService(
      ...
      `/api/v1/pim/employee/${props.empNumber}/contact-details`,
    );
    http.setIgnorePath(
      '/api/v1/pim/employees/[0-9]+/contact-details/validation/(work-emails|other-emails)',
    );
    return {
      http,
    };
      ...
      return new Promise((resolve) => {
        if (contact) {
          ...
          this.http
            .request({
              method: 'GET',
              url: `/api/v1/pim/employees/${this.empNumber}/contact-details/validation/work-emails`,
              params: {
      ...
      return new Promise((resolve) => {
        if (contact) {
          ...
          this.http
            .request({
              method: 'GET',
              url: `/api/v1/pim/employees/${this.empNumber}/contact-details/validation/other-emails`,
              params: {
