...
export default {
  ...
  setup(props) {
    const http = new APIService(
      ...
      `/api/v1/pim/employees/${props.empNumber}/job-details`,
    );
    ...
    this.http
      ...
      .then(() => {
        return this.http.request({
          method: 'GET',
          url: `/api/v1/pim/employees/${this.empNumber}/employment-contract`,
        });
      })
      .then((response) => {
    ...
    onClickTerminate() {
      if (this.termination?.id) {
        ...
        this.http
          .request({
            method: 'DELETE',
            url: `/api/v1/pim/employees/${this.empNumber}/terminations`,
          })
          .then(() => {
            return this.$toast.updateSuccess();
          })
