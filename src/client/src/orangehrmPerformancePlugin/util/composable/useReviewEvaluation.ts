...
export default function useReviewEvaluation(http: APIService) {
  ...
  const getAllKpis = (reviewId: number) => {
    return http.request({
      method: 'GET',
      url: `/api/v1/performance/reviews/${reviewId}/kpis`,
    });
  };
  ...
  const getSupervisorReview = (reviewId: number) => {
    return http.request({
      method: 'GET',
      url: `/api/v1/performance/reviews/${reviewId}/evaluation/supervisor`,
    });
  };
  ...
  const getEmployeeReview = (reviewId: number) => {
    return http.request({
      method: 'GET',
      url: `/api/v1/performance/reviews/${reviewId}/evaluation/employee`,
    });
  };
  ...
  const getFinalReview = (reviewId: number) => {
    return http.request({
      method: 'GET',
      url: `/api/v1/performance/reviews/${reviewId}/evaluation/final`,
    });
  };
