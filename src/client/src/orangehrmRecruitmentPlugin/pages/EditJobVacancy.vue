...
export default {
  ...
  setup(props) {
    ...
    const httpAttachments = new APIService(
      window.appGlobal.baseUrl,
      '/api/v1/recruitment/vacancy/attachments',
    );
    ...
    this.http
      ...
      .then(() => {
        this.httpAttachments
          .request({
            method: 'GET',
            url: `/api/v1/recruitment/vacancies/${this.vacancyId}/attachments`,
          })
          .then((response) => {
            const {data} = response.data;
  ...
  methods: {
    ...
    onUpdateAttachment() {
      ...
      this.httpAttachments
        .request({
          method: 'PUT',
          url: `/api/v1/recruitment/vacancies/${this.vacancyId}/attachments/${this.vacancyAttachment.id}`,
          data: {
            vacancyId: parseInt(this.vacancyId),
