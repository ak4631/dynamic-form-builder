...
```
cd existing_repo
git remote add origin https://gitlab.com/shoubhit.tech/optimust.git
git branch -M main
...
- [ ] Run composer command to get all backend dependencies
...
- [ ] Run yarn command to get all frontend dependencies & build frontend
...
User Login detail with inital Database : admin / Admin@1234
=======
TEST ONE
